...
public class CreateJobAPITest {
	...
	public void setupPayload() {
		...
		Customer_Address customer_address = new Customer_Address("2344", "Galaxy", "Baker street 2111", "Baker street",
				"Goa", "11111", "India", "Goa");
		Customer_Product customer_product = new Customer_Product(DateTimeUtil.getTimewithDaysAgo(10), "89965141310233",
				"89965141307233", "89965141307233", DateTimeUtil.getTimewithDaysAgo(10), Product.NEXUS_2.getCode(),
